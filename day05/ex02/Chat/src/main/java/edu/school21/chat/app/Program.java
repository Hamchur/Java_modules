...
public class Program {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        User user = new User(3, "man6", "GwdkE1qc", new ArrayList<>(), new ArrayList<>());
        Chatroom chatroom = new Chatroom(2, "random", user, new ArrayList<>());
        Message message = new Message(1, user, chatroom, "Test", new Timestamp(System.currentTimeMillis()));
